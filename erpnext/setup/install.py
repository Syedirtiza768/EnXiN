# Copyright (c) 2015, EnXi and Contributors
...
default_mail_footer = """<div style="padding: 7px; text-align: right; color: #888"><small>Sent via
	<a style="color: #888" href="https://github.com/Syedirtiza768/EnXiN">EnXi</a></div>"""
...
def add_standard_navbar_items():
	...
	erpnext_navbar_items = [
		...
		{
			"item_label": _("EnXi Support"),
			"item_type": "Route",
			"route": "https://github.com/Syedirtiza768/EnXiN/issues",
			"is_standard": 1,
		},
		{
...
def add_app_name():
	frappe.db.set_single_value("System Settings", "app_name", "EnXi")
